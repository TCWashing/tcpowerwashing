...
export default function Pathway() {
  ...
  return (
    <>
      ...
      >
        Pathway Pressure Wash/Cleaning
        <AiOutlineInfoCircle
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-base text-gray-700 text-md">
                      Pressure wash of any path and door front. Please specify if you do not want any surfaces washed.*
                    </p>
                    <p className="text-base text-gray-500 text-sm pt-2">*Extra charges may apply if you have an abnormally large pathway, we will notify you of this before the job.</p>
                    <img
