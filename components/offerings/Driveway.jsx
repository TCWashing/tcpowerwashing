            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Driveway and path pressure wash
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-base text-gray-700 text-md">
                      We pressure wash your driveway and any path's in the front of your house. Please specify if you do not want any surfaces washed.*
                    </p>
                    <p className="text-base text-gray-500 text-sm pt-2">*Extra charges may apply if you have an abnormally large driveway, we will notify you of this before the job.</p>
                    <img
