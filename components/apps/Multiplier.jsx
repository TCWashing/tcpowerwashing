...
const Multiplier = () => {
  ...
  useEffect(() => {
    const multiplied1 = parseFloat(sqft1) * 0.17;
    const multiplied2 = parseFloat(sqft2) * 0.19;
  ...
  return (
    ...
    <p className="text-center font-metBold text-2xl uppercase md:hidden">try our pricing calculator!</p>
      <div style={sectionStyle}>
        <h2>House Square Footage ($0.17/sqft)</h2>
        <input
          type="number"
          value={sqft1}
      ...
      <div style={sectionStyle}>
        <h2>Driveway/Path Square Footage ($0.19/sqft)</h2>
        <input
          type="number"
          value={sqft2}
