...
export default function Oversize() {
  ...
  return (
    <>
      ...
      >
        Oversize -{" "}
        <span className="font-metSemiBold">{'50-100'}</span>
        <AiOutlineInfoCircle
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-base text-gray-500">
                      For homes greater than 2500sqft. If over 2500sqft, $50 oversize fee will apply. If over 4500sqft, $100 oversize fee will apply.
                    </p>
                  </div>
