...
export default function CleaningSolution() {
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-base text-gray-500">
                      Includes application of our chemical formula that breaks away at mold and grime. This is done with some driveways/pathways
                      but is primarily used for home application
                    </p>
                    {/* <img
